...
export const SemestreColumn = ({ numSem, materias, onMateriaClick }) => {
  return (
    <div className="min-w-55 bg-[rgba(0,0,0,0.85)] rounded-tr-[15px] rounded-bl-[15px] p-3.75 border-2 border-[#580000] shadow-[0_4px_15px_rgba(0,0,0,0.7),inset_0_0_20px_rgba(139,0,0,0.15)] relative overflow-hidden flex flex-col gap-2">
      ...
      {/* Texto blanco (text-white) y sin borde inferior */}
